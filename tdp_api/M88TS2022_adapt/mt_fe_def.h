...
#define PSD_THRESHOLD		2000
#define PSD_AGC				0x78
#define CCI_AGC				0x7f
#define NEED_CHECK_CCI		0
#endif
...
#define PSD_THRESHOLD		1600//2000
#define PSD_AGC				0x78
#define CCI_AGC				0x7f
#define NEED_CHECK_CCI		0
#endif
...
extern MT_FE_RET mt_fe_tn_cal_tuner_freq_sharp6306(U32 freqKHz, U32 *realfreqKHz);
...
#define	MT_FE_ENHANCE_MCLK_LEVEL			0
...
U32	mt_fe_dmd_ds3k_unicable_FFT_detect(U32 startFreq, U32 *result_freq);
MT_FE_BOOL mt_fe_ds3k_unicable_CCI_detect(U32 startFreq, U32 *result_freq);
