...
#else
#   define SONY_DVB_SLEEP(n) usleep(n)      /**< PORTING. OS abstraction sleep(ms). */
#endif

#ifndef SONY_DVB_SLEEP
#error SONY_DVB_SLEEP(n) has not been defined.
#endif

//[Oliver] disable to SONY log function
...
#       define SONY_DVB_TRACE_I2C_ENTER(func) SONY_DVB_TRACE_ENTER(func)
#       define SONY_DVB_TRACE_I2C_RETURN(result) SONY_DVB_TRACE_RETURN(result)
#   else
