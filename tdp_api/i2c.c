...
int I2C_Init(void)
{
	...
	// Set TWSI Speed here
	if (TWSI_setspeed(TWSI_BUS_ID, TWSI_CUSTOM_SPEED, 100) != 0 ) // set 100KHzt
	    return -1;
	    
	return 0;    
}

int TWSI_writeread_bytes(int master_id, int slv_addr, int addr_type, unsigned char *pwbuf, int wnum, unsigned char *prbuf, int rnum, int dum) 
{
